...
figDIR   = '/scratch/grimesdj/ripchannel/figures/'
outDIR   = '/scratch/grimesdj/ripchannel/mat_data/'
%
%
...
% 'uniRip-ter2D','uniRip-bar2D','highRip-barRip0-s00','highRip-barRip1-s00','highRip-terRip1-s00','highRip-terRip1-s10','highRip-barRip1-s10','highRip-barRip0-s10',
...
runDIR = run_dirs{ii};
%
matDIR   = ['/scratch/grimesdj/ripchannel/',runID,'/mat_data/'];
infoFile = dir([matDIR,filesep,'*','info','*',runDIR,'.mat']);% info   = prep_belegaer_ripchannel_info(runID,runDIR);
