...
%% 1) need a list of run-directories to compare:
...
ag = 0.5;
ppos  = [xm ym pw ph];
cbpos = [xm+pw+ag, ag, ph/2];
ps    = [2*xm+pw+6*ag, 2*ym+ph];
fig   = figure('units','centimeters');
fig.Position(3:4) = ps;
set(fig,'papersize',ps,'paperposition',[0 0 ps])
