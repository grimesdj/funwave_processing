function flog = convert_funwave_output_to_mat(rin,rout,vars,t0,dt0,dx,dy,rmfiles,Nt,tlimits,isBINARY,Mglob,Nglob)
%
% USAGE: fout = convert_funwave_output_to_mat(root_dir,vars,t,dt,rmfiles)
% need to include t, dt, dx=span in columns, dy=span in rows; Nt is number of time-steps to break record into.
