...
for jj = 1:Ndirs
    ...
    [visc,~] = get_funwave_viscocity_breaking_1D(runNAME,rawDIR);    
     Ebr(jj,:)                = get_funwave_Ebr_from_nubrk_p_q(runNAME,rawDIR,dx,dy,Navg);
    clf(fig0)
    ...
    figname = [runDIR,filesep,runNAME,'_viscocity_breaking.pdf'];
