...
for run = 0:15
    ...
    info.rootSim   = sprintf('/data2/ripchannel/flat1D/run%d',run);
    info.rootMat   = '/data2/ripchannel/flat1D/mat_data/';
...
save('/data2/ripchannel/flat1D/mat_data/flat_1D_runs.mat')
